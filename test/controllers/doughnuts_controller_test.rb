...
class DoughnutsControllerTest < ActionController::TestCase
  ...
  test "should create doughnut" do
    assert_difference('Doughnut.count') do
      post :create, doughnut: { cost: @doughnut.cost, description: @doughnut.description, diet: @doughnut.diet, dough: @doughnut.dough, image: @doughnut.image, name: @doughnut.name }
    end
  ...
  test "should update doughnut" do
    patch :update, id: @doughnut, doughnut: { cost: @doughnut.cost, description: @doughnut.description, diet: @doughnut.diet, dough: @doughnut.dough, image: @doughnut.image, name: @doughnut.name }
    assert_redirected_to doughnut_path(assigns(:doughnut))
  end
